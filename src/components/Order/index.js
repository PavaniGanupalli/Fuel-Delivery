...
class Order extends Component {
  ...
  render() {
    const { dbStyle, ofStyle, aoStyle, hStyle, loStyle } = this.state;
        ...
        <div className="bgContainer">
          <div className="profileContainer">
            ...
            <ul className="tabs-container">
              ...
              <Link to="/">
                <li className={loStyle}>
                  <button onClick={this.logout}>
                    <FiLogOut className="dashboard-image" />
                    <p className="tab-des">Logout</p>
                  </button>
                </li>
              </Link>
            </ul>
